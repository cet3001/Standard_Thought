    ...
    <div className="mb-16">
      <div className="text-center mb-8">
        ...
        <p className="text-[#0A0A0A]/70 dark:text-brand-cream/70 max-w-2xl mx-auto">
          Fresh insights from builders who just secured the bag. Hot off the press.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {posts.map((post, index) => (
          <Card 
            ...
            className={`cursor-pointer bg-white/90 dark:bg-brand-black/80 backdrop-blur-sm border-none rounded-none overflow-hidden group transition-all duration-500 hover:scale-105 hover:shadow-xl relative
              /* Torn paper effect */
            ...
            <CardContent className="p-6 relative z-10 flex flex-col flex-grow">
              ...
              {post.theme_tags && post.theme_tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-3">
                  {post.theme_tags.slice(0, 3).map((tag, tagIndex) => (
                    <ThemeTag
                      key={tagIndex}
                      tag={tag}
              ...
              <h3 
                className="text-2xl font-bold mb-4 line-clamp-2 group-hover:text-[#247EFF] transition-colors text-[#0A0A0A] dark:text-brand-cream"
                style={{ 
              ...
              <p className="text-[#0A0A0A]/70 dark:text-brand-cream/70 mb-6 line-clamp-4 font-medium flex-grow">
                {post.excerpt}
              </p>
              
              <div className="flex items-center justify-between text-sm text-[#0A0A0A]/60 dark:text-brand-cream/60 mt-auto">
