...
const StartHereCard = () => {
  return (
    <div className="relative">
      ...
      <Card className="relative bg-gradient-to-br from-[#247EFF]/10 via-blue-50/80 to-[#247EFF]/5 dark:from-[#247EFF]/20 dark:via-blue-900/30 dark:to-[#247EFF]/10 border-2 border-[#247EFF]/30 shadow-lg hover:shadow-xl transition-all duration-300">
