...
const HeroValueProps = () => {
  ...
  const valueProps = [
    ...
    {
      icon: <Bot className="h-6 w-6 sm:h-8 sm:w-8 text-[#247EFF]" aria-label="AI technology and automation icon" />,
    ...
    {
      icon: <BookOpen className="h-6 w-6 sm:h-8 sm:w-8 text-[#247EFF]" aria-label="Financial education and learning icon" />,
