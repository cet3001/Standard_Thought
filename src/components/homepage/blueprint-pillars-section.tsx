  ...
  return (
    <div className={`mb-16 relative transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <div className="text-center mb-12 relative z-10">
        <h2 
          className="text-3xl md:text-4xl font-black mb-4 text-brand-black dark:text-brand-cream transform -rotate-1 relative"
          style={{ 
        ...
        <p className="text-lg text-brand-black/70 dark:text-brand-cream/70 max-w-2xl mx-auto relative">
        ...
        {pillars.map((pillar, index) => (
          ...
          >
            <div className="bg-white/70 dark:bg-brand-black/70 backdrop-blur-sm border-2 border-[#247EFF]/20 hover:border-[#247EFF]/50 rounded-2xl p-6 text-center hover:scale-105 hover:shadow-xl hover:shadow-[#247EFF]/20 transition-all duration-300 cursor-pointer relative overflow-hidden">
              ...
              {/* Enhanced graffiti-style corner tag */}
              <div className="absolute top-2 right-2 w-8 h-8 bg-[#FFD700]/40 transform rotate-45 group-hover:bg-[#FFD700]/60 transition-colors"></div>
              <div className="absolute top-3 right-3 w-4 h-4 bg-[#FFD700]/20 transform rotate-45"></div>
              ...
              <h3 
                className="text-xl font-black text-brand-black dark:text-brand-cream mb-4 group-hover:text-[#247EFF] transition-colors transform -rotate-1 relative"
                style={{ 
                  fontFamily: "'Permanent Marker', 'Kalam', 'Comic Neue', cursive", 
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#247EFF]/15 to-transparent opacity-0 group-hover:opacity-100 transition-opacity blur-lg -z-10"></div>
              </h3>
              
              <p className="text-brand-black/80 dark:text-brand-cream/80 leading-relaxed group-hover:text-brand-black/90 dark:group-hover:text-brand-cream/90 transition-colors relative z-10">
                {pillar.description}
              </p>
              
              {/* Enhanced street-style underline */}
              <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 w-20 h-2 bg-[#247EFF]/30 group-hover:bg-[#247EFF]/70 transition-colors rounded-full"></div>
              <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-[#247EFF]/20 group-hover:bg-[#247EFF]/40 transition-colors rounded-full"></div>
            </div>
          </Link>
        ))}
      </div>
