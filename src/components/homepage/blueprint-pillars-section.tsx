    ...
    <div className={`mb-16 relative transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10" role="group" aria-label="Standard Thought methodology pillars">
        {pillars.map((pillar, index) => (
          ...
          >
            <div className="backdrop-blur-sm rounded-3xl p-6 text-center hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer relative overflow-hidden"
                 style={{ 
              ...
              <h3 
                className="text-xl font-black text-brand-black dark:text-brand-cream mb-4 transition-colors transform -rotate-1 relative"
                style={{ 
                  fontFamily: "'Permanent Marker', 'Kalam', 'Comic Neue', cursive", 
