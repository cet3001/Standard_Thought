...
interface FlipTheScriptSectionProps {
  isVisible: boolean;
}
...
const FlipTheScriptSection = ({ isVisible }: FlipTheScriptSectionProps) => {
  return (
      ...
      <div className="relative bg-white/5 dark:bg-black/20 backdrop-blur-sm rounded-2xl p-8 border border-white/10 dark:border-black/10">
        ...
        <div className="text-center mb-12 relative z-10">
          <h2 className="text-3xl md:text-4xl font-black mb-4">
            <span style={{ color: 'var(--color-lovable-black)' }}>Flip the</span> <span className="pearlescent-text">Script</span>
          </h2>
        </div>
...
export default FlipTheScriptSection;