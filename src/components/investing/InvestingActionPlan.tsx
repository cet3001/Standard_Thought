...
const InvestingActionPlan = () => {
  ...
  const handleDownloadGuide = async () => {
    trackButtonClick('Download Guide', 'investing_page', 'investing_action_plan');
    
    if (!investingGuide) {
      console.error('Investing guide not found');
      return;
    }
    
    // Simple email collection
    const email = prompt('Enter your email to download the Investing Action Plan:');
    if (!email) return;
        ...
        <div className="bg-gradient-to-r from-[#FFD700]/10 to-[#FFA500]/10 backdrop-blur-sm rounded-2xl p-8 sm:p-12 border-2 border-[#FFD700]/30">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-black dark:text-brand-cream leading-relaxed mb-8 max-w-2xl mx-auto">
              Download the <strong>Investing Action Plan</strong>: Your step-by-step guide to building your first portfolio from scratch.
            </p>
...
export default InvestingActionPlan;