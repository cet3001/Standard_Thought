...
const SectionOverlayBox = ({ children, className }: SectionOverlayBoxProps) => {
  return (
    <div 
      className={cn(
        "relative backdrop-blur-sm border border-gray-300/20 rounded-3xl p-8 mb-16 overflow-hidden bg-white/95 dark:bg-brand-black/95",
        className
      )}
      style={{
    ...
    >
      {/* Torn Paper Effect Background - Same as homepage */}
      ...
      {/* Gritty texture overlay - Same as homepage */}
