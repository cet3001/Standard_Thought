...
const LeadMagnetPopup = () => {
  ...
  // Immediate gritty brick SVG pattern - no delay
  ...
  // Stronger overlay for better readability, blend with brick
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Subtle loading indicator for texture generation - no blocking overlay */}
