  ...
  if (!user) {
    return (
      <Button 
        ...
        className="bg-gradient-to-r from-accent to-[#FFD700] text-black font-bold hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg rounded-full px-4 lg:px-8 py-2 lg:py-3 border-0 text-xs lg:text-sm"
    ...
    <div className="flex items-center space-x-2 lg:space-x-4" role="group" aria-label="User account actions">
      {isAdmin && (
        <Button
          ...
          variant="outline"
          size="sm"
          className="bg-gradient-to-r from-accent to-[#FFD700] text-black font-bold hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg px-2 lg:px-4 py-1 lg:py-2 rounded-2xl border-0 text-xs lg:text-sm"
