...
const NewsletterSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-r from-accent/10 via-background to-accent/10 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          {!isSubmitted ? (
            <>
              ...
              {/* Incentive */}
              <div className="bg-card border border-accent/20 rounded-3xl p-6 mb-8 glass-effect">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto mb-8">
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    className="pl-10 py-6 rounded-2xl border-accent/20 focus:border-accent"
                    required
                  />
                </div>
                <Button 
