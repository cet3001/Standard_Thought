...
const NewsletterSection = () => {
  ...
  return <section className="py-24 bg-white/90 dark:bg-brand-black/90 backdrop-blur-sm relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          {!isSubmitted ? <>
              ...
              <div className="mb-8">
                ...
                <p className="text-xl text-[#0A0A0A]/80 dark:text-brand-cream/80">Get exclusive insights, behind-the-scenes stories, and actionable strategies delivered to your inbox. No spam, just pure value from builders who've been where you're going.agn</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto mb-8">
                <div className="flex-1 relative">
                  ...
                  <Input type="email" placeholder="Enter your email address" value={email} onChange={e => setEmail(e.target.value)} className="pl-10 py-6 rounded-2xl border-[#247EFF]/20 focus:border-[#247EFF] bg-white/80 dark:bg-brand-black/80 text-[#0A0A0A] dark:text-brand-cream placeholder:text-[#0A0A0A]/50 dark:placeholder:text-brand-cream/50" required />
                </div>
                <Button type="submit" size="lg" className="bg-[#247EFF] hover:bg-[#0057FF] hover:shadow-lg hover:shadow-[#D4AF37]/30 text-white font-semibold px-8 py-6 rounded-2xl whitespace-nowrap transition-all duration-300 hover:scale-105">
                  Join Movement
                </Button>
              </form>
