        ...
        <section className="py-16 relative">
          <div className="container mx-auto px-6 max-w-4xl relative z-10">
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
              {/* FAQ Item 1 */}
              <div className="bg-white/10 dark:bg-gray-800/10 backdrop-blur-sm rounded-xl border border-gray-300/10 dark:border-gray-700/10 overflow-hidden">
                <details className="group">
                  ...
                  <div className="px-6 pb-6">
                    <p className="text-lg text-black dark:text-brand-cream leading-relaxed">
                      Nah, most AI tools run on your phone or any laptop. You don't need anything fancy—just an internet connection and the willingness to get started.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="bg-white/10 dark:bg-gray-800/10 backdrop-blur-sm rounded-xl border border-gray-300/10 dark:border-gray-700/10 overflow-hidden">
                <details className="group">
                  ...
                  <div className="px-6 pb-6">
                    <p className="text-lg text-black dark:text-brand-cream leading-relaxed">
                      We break it down step-by-step—no tech jargon, just real moves. Everyone starts somewhere, and we'll show you exactly how to go from zero to your first dollar.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="bg-white/10 dark:bg-gray-800/10 backdrop-blur-sm rounded-xl border border-gray-300/10 dark:border-gray-700/10 overflow-hidden">
                <details className="group">
                  ...
                  <div className="px-6 pb-6">
                    <p className="text-lg text-black dark:text-brand-cream leading-relaxed">
                      Some hustlers get paid in their first week. The key is consistency and not being afraid to start small. Even $50 your first week is $50 more than you had before.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="bg-white/10 dark:bg-gray-800/10 backdrop-blur-sm rounded-xl border border-gray-300/10 dark:border-gray-700/10 overflow-hidden">
                <details className="group">
                  ...
                  <div className="px-6 pb-6">
                    <p className="text-lg text-black dark:text-brand-cream leading-relaxed">
                      AI isn't going anywhere—it's getting bigger every day. The people who learn to use it now will be the ones winning tomorrow. This isn't just a side hustle, it's a skill that scales.
                    </p>
                  </div>
                </details>
              </div>
