...
const CreatePost = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Create New Story | Standardthought</title>
        <meta name="description" content="Share your builder journey with the community. Create inspiring stories for fellow entrepreneurs." />
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="border-t border-[#247EFF]/20 pt-6">
                    <h3 className="text-lg font-semibold text-[#0A0A0A] dark:text-brand-cream mb-4">SEO Metadata</h3>
                    
                    <div className="space-y-4">
                      <div>
                        <Label htmlFor="metaDescription" className="text-[#0A0A0A] dark:text-brand-cream">Meta Description</Label>
                        <Textarea
                          id="metaDescription"
                          value={formData.metaDescription}
                          onChange={(e) => setFormData({...formData, metaDescription: e.target.value})}
                          placeholder="SEO description (will use excerpt if left empty)"
                          rows={2}
                          className="bg-brand-cream/50 dark:bg-brand-black/50 border-[#E5E5E5] dark:border-[#2A2A2A] focus:border-[#247EFF] text-[#0A0A0A] dark:text-brand-cream"
                        />
                        <p className="text-sm text-[#0A0A0A]/60 dark:text-brand-cream/60 mt-1">
                          Recommended: 150-160 characters
                        </p>
                      </div>
                      
                      <div>
                        <Label htmlFor="metaKeywords" className="text-[#0A0A0A] dark:text-brand-cream">Meta Keywords</Label>
                        <Input
                          id="metaKeywords"
