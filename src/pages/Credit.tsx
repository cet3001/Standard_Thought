              ...
              <div className="text-center">
                ...
                <button 
                  onClick={() => {
                    ...
                    console.log('Download Credit Action Plan');
                  }}
                  className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-black font-black text-xl rounded-xl transition-all duration-300 hover:scale-105 transform rotate-1 hover:rotate-0 shadow-lg hover:shadow-xl"
                  style={{
                    fontFamily: 'Permanent Marker, cursive',
