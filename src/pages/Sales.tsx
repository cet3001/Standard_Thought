    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="relative z-10" style={{ marginTop: `${headerHeight}px`, paddingTop: '3rem' }}>
        ...
        <section className="pb-24 relative overflow-hidden">
          {/* Enhanced Urban Background with Better Texture Visibility - MATCHING REST OF PAGE */}
          <div className="absolute inset-0" aria-hidden="true">
            ...
            {/* Background gradient overlay - MATCHING THE GLOBAL OVERLAY */}
            <div className="absolute inset-0 bg-gradient-to-br from-slate-800/50 via-slate-700/60 to-slate-900/50"></div>
            
            {/* Content overlay for text readability - MATCHING THE GLOBAL OVERLAY */}
            <div className="absolute inset-0 bg-gradient-to-b from-brand-cream/85 via-brand-cream/90 to-brand-cream/85 dark:from-brand-black/85 dark:via-brand-black/90 dark:to-brand-black/85"></div>
          </div>
